...
export const SECTIONS: Section[] = [
  ...
  { id: "ai-recommendation", label: "AI Recommendation", description: "Analyze findings, evidence, contradictions, factors, and corrective-action options", icon: Gavel, isAI: true },
  { id: "decisions", label: "Decision Framework", description: "Manually weigh the same factors without an automatic punishment score", icon: Scale },
